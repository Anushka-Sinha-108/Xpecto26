    ...
    >
      ...
      >
        ...
        <div className="relative p-6 space-y-4">
          ...
          {(workshop.venue || workshop.speaker) && (
            <motion.div
            ...
            >
              ...
              <div>
                <p className="font-['Roboto'] text-white text-sm font-semibold">
                  {workshop.speaker || workshop.venue}
                </p>
    ...
    const fetchWorkshops = async () => {
      try {
        ...
        if (data.success) {
          ...
          transformedData.forEach((workshop) => {
  ...
  return (
    <div ref={containerRef} className="w-full min-h-screen relative bg-black">
      ...
      <div className="relative z-10">
        ...
        {/* Scrollable Workshops Container */}
          ...
          >
            {loading ? (
              ...
              Object.entries(groupedWorkshops).map(
                ([dateLabel, dateWorkshops], groupIndex) => (
